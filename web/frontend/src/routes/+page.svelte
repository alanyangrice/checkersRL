...
<!-- Footer -->
<div class="mt-12 pt-6 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between text-xs text-gray-500 gap-2">
	<p>Created by <span class="font-medium text-gray-700">Alan Yang</span></p>
	<a href="https://github.com/alanyangrice/checkers-rl" target="_blank" rel="noopener noreferrer" class="hover:text-gray-800 transition-colors flex items-center gap-1.5">
