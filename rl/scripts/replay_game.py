...
Usage:
    ...
    python -m rl.scripts.replay_game --file path/to/detailed_games.csv --game 5

    # Replay from a ZIP archive
    python -m rl.scripts.replay_game --file path/to/detailed_games.zip --game 10
    ...
    if file_path.endswith(".zip"):
        with zipfile.ZipFile(file_path, "r") as zf:
            ...
            with zf.open(csv_names[0]) as f:
                return find_game_in_csv(io.TextIOWrapper(f, encoding="utf-8"), game_row)
    else:
        with open(file_path, "r", encoding="utf-8") as f:
            return find_game_in_csv(f, game_row)


def find_game_in_csv(file_obj, game_row):
...
Examples:
  python -m rl.scripts.replay_game -f detailed_games_epoch_150.csv -g 5
  python -m rl.scripts.replay_game -f detailed_games_epoch_10.zip -g 42
  python -m rl.scripts.replay_game --moves "11-15, 24-20, 8-11, 28-24"
""",
    )
