...
from RL_models.PPO_Model.train_parallel import run_benchmark
...
if __name__ == "__main__":
    ...
    base_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "RL_models", "PPO_Model")
    ...
    bench = run_benchmark(agent, n_actions, num_processes, reference_model_path, num_games=benchmark_games)
